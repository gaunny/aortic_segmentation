...
with tf.Session() as sess:
    ...
    saver.save(sess,"Results/pad256/unet_sag_25_aug_150_filter/model.ckpt")
    np.save('Results/pad256/train_hist/unet_25_aug_150_filter/train_loss_sag',train_loss)
    np.save('Results/pad256/train_hist/unet_25_aug_150_filter/train_acc_sag',train_accuracy)
    np.save('Results/pad256/train_hist/unet_25_aug_150_filter/valid_loss_sag',test_loss)
    np.save('Results/pad256/train_hist/unet_25_aug_150_filter/valid_acc_sag',test_accuracy)
    np.save('Results/pad256/train_hist/unet_25_aug_150_filter/train_dice_sag',train_dice)
    np.save('Results/pad256/train_hist/unet_25_aug_150_filter/valid_dice_sag',test_dice)
